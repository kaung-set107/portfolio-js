       ...
       this.$body
        ...
        .map(function () {
         var e = t(this),
          ...
          r = /^#./.test(o) && t(o);
         return (
          (r && r.length && r.is(":visible") && [[r[n]().top + i, o]]) || null
         );
        })
        .sort(function (t, e) {
         return t[0] - e[0];
    ...
    (s.VERSION = "3.3.7"),
     ...
     (s.prototype.keydown = function (n) {
      if (
       ...
       var i = t(this);
       if (
        (n.preventDefault(), n.stopPropagation(), !i.is(".disabled, :disabled"))
       ) {
        var o = e(i),
         s = o.hasClass("open");
  ...
  !(function (e, n) {
   ...
   function L(t, e, n, i) {
    ...
    if (
     ...
     for (a = yt.map(T(o, "script"), A), l = a.length; f < d; f++)
      (c = o),
       f !== p && ((c = yt.clone(c, !0, !0)), l && yt.merge(a, T(c, "script"))),
       n.call(t[f], c, f);
     if (l)
   ...
   function X(t, e, n) {
    ...
    for (i in e)
     if (((o = e[i]), be.test(o))) {
      if (
       (delete e[i], (r = r || "toggle" === o), o === (g ? "hide" : "show"))
      ) {
     ...
     if ((i = G.prefilters[r].call(c, t, u, c.opts)))
      return (
       yt.isFunction(i.stop) &&
        (yt._queueHooks(c.elem, c.opts.queue).stop = yt.proxy(i.stop, i)),
       i
      );
    return (
     yt.map(u, Y, c),
    ...
    return (
     ...
     (S = e.select =
      function (t, e, n, i) {
       ...
       return (
        (u || k(t, d))(i, e, !I, n, !e || (mt.test(t) && c(e.parentNode)) || e),
        n
       );
      }),
   ...
   (yt.filter = function (t, e, n) {
    ...
    yt.fn.extend({
     ...
     is: function (t) {
      return !!c(this, "string" == typeof t && St.test(t) ? yt(t) : t || [], !1)
       .length;
     },
    });
   var Dt,
    ...
    if (((n = n || Dt), "string" == typeof t)) {
     ...
     if (i[1]) {
      if (
       ...
       yt.merge(
        this,
        yt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : st, !0)
       ),
    ...
    yt.fn.extend({
     data: function (t, e) {
      ...
      if (void 0 === t) {
       if (
        this.length &&
        ((o = Ht.get(r)), 1 === r.nodeType && !Ft.get(r, "hasDataAttrs"))
       ) {
        for (n = s.length; n--; )
         s[n] &&
          ((i = s[n].name),
    ...
    yt.extend({
     ...
     dequeue: function (t, e) {
      ...
      "inprogress" === o && ((o = n.shift()), i--),
       o &&
        ("fx" === e && n.unshift("inprogress"), delete r.stop, o.call(t, s, r)),
       !i && r && r.empty.fire();
     },
    ...
    style: function (t, e, n, i) {
     if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
      var o,
       ...
       c = t.style;
      if (
       (l || (e = H(a)), (s = yt.cssHooks[e] || yt.cssHooks[a]), void 0 === n)
      )
      ...
      select: {
       ...
       set: function (t, e) {
        for (var n, i, o = t.options, r = yt.makeArray(e), s = o.length; s--; )
         (i = o[s]),
          (i.selected = yt.inArray(yt.valHooks.option.get(i), r) > -1) &&
           (n = !0);
      ...
      return {
       send: function (o, r) {
        var s,
         a = t.xhr();
        if (
         (a.open(t.type, t.url, t.async, t.username, t.password), t.xhrFields)
        )
   ...
   return (
    (yt.noConflict = function (t) {
     return (
      n.$ === yt && (n.$ = Ge), t && n.jQuery === yt && (n.jQuery = Qe), yt
     );
    }),
    r || (n.jQuery = n.$ = yt),
    yt
